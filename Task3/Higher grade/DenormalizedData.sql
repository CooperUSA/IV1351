...
((SELECT id FROM booking WHERE id = 3),
    (SELECT person_id FROM student WHERE id = 2),
    NULL),
...
((SELECT id FROM booking WHERE id = 2),
    (SELECT person_id FROM student WHERE id = 4),
    NULL),
...
((SELECT id FROM booking WHERE id = 2),
    (SELECT person_id FROM student WHERE id = 5),
    NULL),

((SELECT id FROM booking WHERE id = 1),
    (SELECT person_id FROM student WHERE id = 6),
    NULL),
((SELECT id FROM booking WHERE id = 2),
    (SELECT person_id FROM student WHERE id = 6),
    NULL),
...
((SELECT id FROM booking WHERE id = 4),
    (SELECT person_id FROM student WHERE id = 9),
    'Guitar'),

((SELECT id FROM booking WHERE id = 4),
    (SELECT person_id FROM student WHERE id = 10),
    'Drums'),
...
((SELECT id FROM booking WHERE id = 4),
    (SELECT person_id FROM student WHERE id = 12),
    'Piano'),
((SELECT id FROM booking WHERE id = 6),
    (SELECT person_id FROM student WHERE id = 12),
    'Piano'),
...
((SELECT id FROM booking WHERE id = 4),
    (SELECT person_id FROM student WHERE id = 13),
    'Guitar'),
((SELECT id FROM booking WHERE id = 6),
    (SELECT person_id FROM student WHERE id = 14),
    'Guitar'),
...
((SELECT id FROM booking WHERE id = 9),
    (SELECT person_id FROM student WHERE id = 16),
    'Piano'),

((SELECT id FROM booking WHERE id = 9),
    (SELECT person_id FROM student WHERE id = 17),
    'Guitar'),

((SELECT id FROM booking WHERE id = 9),
    (SELECT person_id FROM student WHERE id = 18),
    'Harp');
